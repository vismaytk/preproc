...
def process_tabular_data(file, options):
    try:
        ...
        st.error("Could not connect to the backend server. Please make sure it's running at " + API_URL)
        return None, None
